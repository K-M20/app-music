...
export const ALBUMS: Album[] = [
  {
    ...
    "duration": 600,
    "url": "https://media.istockphoto.com/vectors/vector-play-button-icon-vector-id1066846868?k=20&m=1066846868&s=170667a&w=0&h=Im7iVQrQ7IBBERrs5oy0vnDT0DqaPstrLngFlyP0y_s=",
    "like": "Much",
    "tags": [
      "nisi",
      "do",
